...
namespace backEnd.Controllers
{
    ...
    public class usersController : Controller
    {
        ...
        public usersController(backEndUserManager userManager, 
        ...
        private backEndUserManager _userManager;
        public backEndUserManager UserManager
        {
            get
            {
                return _userManager ?? HttpContext.GetOwinContext()
                    .GetUserManager<backEndUserManager>();
            }
            private set
            {
                _userManager = value;
        ...
        private backEndGroupManager _groupManager;
        public backEndGroupManager GroupManager
        {
            get
            {
                return _groupManager ?? new backEndGroupManager();
            }
            private set
            {
                _groupManager = value;
